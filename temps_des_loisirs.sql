...
INSERT INTO `album` VALUES (1,'Soirée Bingo','2020-02-17'),(2,'Voyage au Brésil','2019-02-17'),(3,'Atelier Salsa','2021-07-01'),(4,'Parc du Poutyl','2015-09-15');
...
INSERT INTO `event` VALUES (1,'Voyage Saint Malo','2021-05-13','2021-05-27',150,'nous irons a st malo','https://picsum.photos/200'),(3,'Voyage Nice','2021-07-16','2020-08-17',150,'Nous irons à Nice.','https://picsum.photos/200'),(4,'Visit Parc de Potyl','2021-09-15',NULL,20,'Nous visiterons le parc de potyl pour prendre des photos.','https://picsum.photos/200'),(6,'Voyage à Mont-Saint-Michel','2021-06-09','2021-06-12',800,'Voyage à Mont-Saint-Michel.','https://picsum.photos/200'),(7,'Voyage au Brésil','2021-04-22','2021-04-29',5500,'Voyage à Rio de Janeiro.','https://picsum.photos/200'),(12,'Bingo familial','2021-04-25','2021-04-25',15,'bingo!','https://picsum.photos/id/1/200/300'),(13,'Voyage à Nice','2022-07-17','2022-07-17',20,'','https://picsum.photos/200/300');
...
VALUES
  (
    1,
    'alert',
    'En raison du Covid, le club Bingo est annulé',
    '2021-02-07'
  ),(
    2,
    'warning',
    "L'atelier danse se fera en visioconférence",
    '2021-02-17'
